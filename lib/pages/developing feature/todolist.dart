...
class _ToDoListPageState extends State<ToDoListPage> {
  ...
  Future<void> _fetchToDoList() async {
    if (_currentUser != null) {
      final snapshot = await _firestore
          ...
          .collection('todos')
          .orderBy('dateTime') // Fetch tasks sorted by date and time
          .get();
      setState(() {
  ...
  Future<void> _editTask(
      String taskId, String taskName, String? dateTime) async {
    if (_currentUser != null && dateTime != null) {
      await _firestore
          .collection('users')
          .doc(_currentUser!.uid)
          .collection('todos')
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TodoBox(
                          ...
                          editFunction: (context) => _showAddTaskDialog(),
